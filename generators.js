...
const GENERATORS = [
 {
  "id": "gen-generac-codes-quicklookup",
  "series": "Generac (fault-code quick lookup)",
  "family": "Generac - Fault Code Quick Lookup (ALL controllers: air-cooled + liquid-cooled)",
  "controller": "All Generac controllers",
  "kw": [],
  "engine": "Reference list - not a specific model. Codes shift by controller generation; confirm on the unit's own display and diagnostic manual.",
  "fuel": "N/A",
  "years": "reference",
  "sort": 0,
  "models": [],
  ...
  "alarms": [
   ...
   { "code": "1001", "name": "Controller Fault - LCD to main board [liquid-cooled]", "meaning": "Main board is not receiving communication from the LCD display - the paired code to 0180. Check the harness/2-pin connector; replace the controller if it persists." },
   { "code": "1100", "name": "Overcrank", "meaning": "Engine cranked but did not start. Check fuel supply/pressure, gas valves, spark, and the actuator/stepper. First-start overcrank from trapped air is normal - retry. [air-cooled + liquid-cooled]" },
   { "code": "1101", "name": "Overcrank (variant)", "meaning": "Liquid-cooled: fuel pressure dropped during cranking (gas). Air-cooled 8-9 kW: start attempts capped at 10 to protect the starter. [air-cooled 8-9kW + liquid-cooled]" },
   { "code": "1200", "name": "Overspeed - prolonged", "meaning": "Frequency at/above ~72 Hz (60 Hz unit) for 3+ s. Air-cooled: stepper/mixer. Liquid-cooled: Bosch throttle actuator/governor/fuel. [air-cooled + liquid-cooled]" },
   { "code": "1201", "name": "Overspeed - throttle stuck open [liquid-cooled]", "meaning": "Prolonged overspeed with the throttle reading open. Check the Bosch actuator and linkage." },
   { "code": "1204", "name": "Overspeed - external ignition module [liquid-cooled gas]", "meaning": "Speed >30% above normal reported by the external ignition module." },
   { "code": "1205", "name": "Overspeed - instantaneous", "meaning": "At/above ~75 Hz (60 Hz) instantaneously. Air-cooled: stepper/mixer. Liquid-cooled: actuator/governor. [air-cooled + liquid-cooled]" },
   { "code": "1206", "name": "Overspeed - instantaneous, throttle stuck [liquid-cooled]", "meaning": "Instantaneous overspeed with the throttle stuck open." },
   { "code": "1207", "name": "Overspeed - AVR zero-cross backup [air-cooled]", "meaning": "Backup overspeed monitor to 1200/1205; rare." },
   { "code": "1300", "name": "Low Oil Pressure", "meaning": "Oil low or faulty low-oil-pressure switch. Check oil level, then the switch and wiring. [air-cooled + liquid-cooled]" },
   { "code": "1400", "name": "High Temperature", "meaning": "Engine/coolant over-temp (liquid-cooled ~246 F) or high-temp switch tripped (air-cooled). Check airflow/vents, coolant/water pump/radiator (LC), and the temp switch. [air-cooled + liquid-cooled]" },
   ...
   { "code": "1600", "name": "Underspeed", "meaning": "Below ~83% (LC) / 55 Hz for 30 s (AC) of rated speed. Overload or a throttle/fuel/stepper problem. [air-cooled + liquid-cooled]" },
   { "code": "1601", "name": "Underspeed - low fuel pressure [liquid-cooled gas]", "meaning": "Low fuel pressure measured before the underspeed trip." },
   { "code": "1602", "name": "Underspeed - throttle stuck closed [liquid-cooled]", "meaning": "Bosch actuator stuck closed. Check the actuator and linkage." },
   { "code": "1603", "name": "Underspeed - never reached 3600 RPM at start [air-cooled]", "meaning": "Stepper or fuel-selector issue during start." },
   { "code": "1800", "name": "Overvoltage", "meaning": "Output above ~110% of rated (LC also 1801 instantaneous +30%, 1803 speed-related). Check the voltage regulator/field and sensing wiring. [air-cooled + liquid-cooled]" },
   { "code": "1900", "name": "Undervoltage", "meaning": "Below ~80% of rated for 10+ s. Check stator/rotor/brushes, field, wiring, and for overload. [air-cooled + liquid-cooled]" },
   { "code": "1901", "name": "Undervoltage - sudden drop", "meaning": "Output dropped below ~15 V for 2+ s. Stator/rotor/brush/wiring or overload. [air-cooled + liquid-cooled]" },
   { "code": "1902", "name": "Undervoltage - both zero-crosses missing", "meaning": "Both AC zero-crosses missing for 1.5+ s. Excitation winding / zero-cross circuit / field boost. [air-cooled + liquid-cooled]" },
   { "code": "1903", "name": "Undervoltage - no output [liquid-cooled]", "meaning": "Generator output below 120 V." },
   { "code": "1904", "name": "Undervoltage - no field current [liquid-cooled]", "meaning": "No field current detected. Check the brushes and field wiring." },
   { "code": "1905", "name": "Undervoltage - low speed 30 s [liquid-cooled]", "meaning": "Running below normal speed for 30+ s. Check fuel/governor." },
   { "code": "1906", "name": "Undervoltage - single zero-cross missing [air-cooled number]", "meaning": "One AC zero-cross missing for 1.5+ s. SAME fault the liquid-cooled controller numbers 1916 - the number differs by platform (air-cooled 1906 / liquid-cooled 1916)." },
   { "code": "1916", "name": "Undervoltage - single zero-cross missing [liquid-cooled number]", "meaning": "One AC zero-cross missing for 1.5+ s. SAME fault air-cooled numbers 1906. Excitation winding / zero-cross circuit." },
   { "code": "2099", "name": "Wiring Error", "meaning": "High- and low-voltage leads (194/23/N1/T1) confused at install - detected on power-up. Correct the field wiring. [air-cooled + liquid-cooled]" },
   { "code": "2100", "name": "Overload - Remove Load [air-cooled number]", "meaning": "CT-detected overload. SAME condition the liquid-cooled controller numbers 2101 (air-cooled 2100 / liquid-cooled 2101). Remove load or add load-shedding." },
   { "code": "2101", "name": "Overload - Remove Load [liquid-cooled number]", "meaning": "Overload with elevated field current. SAME condition air-cooled numbers 2100. Remove load or add a load manager." },
   { "code": "2102", "name": "Overload - 8-9 kW re-crank/stall [air-cooled]", "meaning": "Re-crank or stall under load (8-9 kW air-cooled)." },
   { "code": "2103", "name": "Overload - 8-9 kW load-accept fail [air-cooled]", "meaning": "10 failed load-accept attempts (8-9 kW air-cooled)." },
   { "code": "2299", "name": "Undervoltage Overload [air-cooled]", "meaning": "A large load was connected at start. Reduce start-up load." },
   { "code": "2399", "name": "Stepper Overcurrent [air-cooled]", "meaning": "Stepper (mixer) motor circuit over-current. Test the stepper and its harness. (Air-cooled uses a STEPPER; liquid-cooled uses a Bosch actuator - see 2500-2502.)" },
   { "code": "2400", "name": "Fuse Problem", "meaning": "The 7.5 A ATO control fuse is missing or blown (flagged directly on firmware older than ~1.12/1.30). Replace it and find the cause - a repeatedly blowing 7.5 A fuse with blinking lights is the classic 0180 comm-fault signature. [air-cooled + liquid-cooled]" },
   { "code": "2500", "name": "Bosch Actuator fault [liquid-cooled]", "meaning": "Throttle actuator command/feedback mismatch (2500), stuck open (2501), or stuck closed (2502). Check the actuator, harness, and throttle body." },
   { "code": "2600", "name": "Ignition Fault [liquid-cooled gas]", "meaning": "Ignition coils, cam sensor, or crank circuit: 2600 general, 2601 missing cam pulse, 2602 crank circuit. Check coil packs and sensors." },
   { "code": "2611", "name": "Cylinder Coil OVER-current [liquid-cooled gas]", "meaning": "Coil-pack current too HIGH on a cylinder, one code per cylinder: 2611 2612 2613 2614 2615 2616 2617 2618 2619 2620 = cylinders 1-10. Test and replace that coil pack/boot." },
   { "code": "2621", "name": "Cylinder Coil UNDER-current [liquid-cooled gas]", "meaning": "Coil-pack current too LOW on a cylinder, one per cylinder: 2621 2622 2623 2624 2625 2626 2627 2628 2629 2630 = cylinders 1-10. Test and replace that coil pack/boot; check the connector." },
   { "code": "2650", "name": "Missing Cam [liquid-cooled gas]", "meaning": "No cam pulses after 4 s of cranking: 2650 internal ignition / 2651 external ignition module. Check the cam sensor and wiring." },
   { "code": "2660", "name": "Missing Crank Pulses [liquid-cooled gas]", "meaning": "No crank pulses: 2660 internal / 2661 external module. Magnetic pickup fault." },
   { "code": "2670", "name": "CAN Bus Error [liquid-cooled]", "meaning": "Controller-to-module CAN communication loss (widely reported in the field, e.g. 48 kW 4.5L). Check battery/cranking voltage drop, flyback diodes, the harness, and update controller + ECU/module firmware together. Related: 2671 (ignition module), 2672 (diesel ECU)." },
   { "code": "2671", "name": "CAN Bus - ignition module [liquid-cooled gas]", "meaning": "Bad module, damaged CAN wiring, or wrong controller boot-up order." },
   { "code": "2672", "name": "CAN Bus - diesel ECU [liquid-cooled diesel]", "meaning": "Bad ECU, programming issue, or wrong boot-up order." },
   { "code": "2700", "name": "Fuel Level Low - critical [liquid-cooled diesel]", "meaning": "Diesel below 10% for 60 s. Add fuel or test the sender." },
   { "code": "2751", "name": "Very Low Battery", "meaning": "Battery under 9.0 V for 60 s. Load-test/replace the battery; check the charger (T1) and connections. [air-cooled + liquid-cooled]" },
   { "code": "2800", "name": "Aux Shutdown / E-Stop", "meaning": "External emergency-stop or auxiliary shutdown not in the ON/run position (2800/2801). Check both E-stop and any aux shutdown switches. [air-cooled + liquid-cooled]" },
   { "code": "2810", "name": "Hall Calibration [liquid-cooled]", "meaning": "Hall-effect current sensor not calibrated. Update firmware and reboot; recalibrate per the diagnostic manual." },
   { "code": "2900", "name": "Diesel ECU Fault [liquid-cooled diesel]", "meaning": "The diesel ECU is reporting a fault over J1939 CAN. This is a wrapper - read the actual SPN/FMI diagnostic code at the engine ECU; it is not fully described by the Generac number alone." },
   { "code": "Controller Fault", "name": "Named alarms - Evolution 2.0 / Sync 3.0 [air-cooled, no number shown]", "meaning": "Newer air-cooled firmware shows plain-text alarms with no e-code number: Loss of Serial Link, Loss of Speed Signal, Emergency Stop, Low Volts Remove Load, Firmware Error-7. 'Loss of Serial Link' is the same display-to-controller comm fault as 0180." }
  ],
  "warnings": [
   { "code": "2680", "name": "Low Fuel Level [liquid-cooled diesel]", "meaning": "Diesel tank 10-20% for 60+ s." },
   { "code": "2690", "name": "Low Fuel Pressure [gas]", "meaning": "Gaseous fuel pressure low for 60+ s. Check the meter/regulator, upstream demand, and pipe sizing." },
   ...
   { "code": "WiFi", "name": "Named warnings - Evolution 2.0 / Sync 3.0 [air-cooled, no number]", "meaning": "Plain-text warnings with no e-code number: Fuel Pressure, Overload Warning, USB Warning, Download Failure, No WiFi Module, No WiFi Router Comms, No WiFi Server Comms, Inspect Battery, Firmware Error-9, Exercise Set Error." },
   { "code": "Nexus", "name": "Nexus controllers show NO numeric e-codes", "meaning": "Older Nexus (air-cooled and industrial) does not use 4-digit e-codes - it shows plain-text messages (Under Voltage, Overcrank, RPM Sensor Loss, etc.) plus a green/yellow/red LED. The 4-digit code system started with Evolution. For Nexus, read the LCD text and the tricolor LED. H-100 industrial uses text alarms too (SD/Al/Wr prefixes) - see the SG/QT industrial families." }
  ],
  "installNotes": [
   "This is a QUICK-LOOKUP reference spanning ALL Generac controllers - it is not tied to one model. Always confirm the code on the unit's own display and its diagnostic manual: air-cooled Evolution, liquid-cooled Evolution, Nexus (no numbers), and H-100 industrial each have their own scheme.",
   "Air-cooled vs liquid-cooled numbering differs for a few faults: Overload is 2100 (air-cooled) vs 2101 (liquid-cooled); single-zero-cross undervoltage is 1906 (air-cooled) vs 1916 (liquid-cooled). Both are listed above so either search resolves.",
   "Air-cooled units use a STEPPER motor (see 2399); liquid-cooled units use a Bosch throttle actuator (see 2500-2502). Ignition per-cylinder, CAN-bus, fuel-level, diesel-ECU, coolant, and gaseous-emissions codes are liquid-cooled only."
  ],
  "tips": [
   "Search any Generac code number here (e.g. 0180, 1902, 2100, 2400) - this list carries every number literally so it always resolves, then open the specific model family for full context.",
   "The per-code diagnostic flowcharts are in the Generac diagnostic manuals: air-cooled 0H9172 (Evolution/Nexus) and liquid-cooled 0J1195 (Evolution/Nexus)."
  ],
  "manuals": [
   { "title": "Generac Air-Cooled Diagnostic/Repair Manual 0H9172 (Evolution or Nexus)", "docType": "diagnostic", "url": "https://www.generac.com/service-support/product-support-lookup/" },
   { "title": "Generac Liquid-Cooled Diagnostic Manual 0J1195 (Evolution or Nexus)", "docType": "diagnostic", "url": "https://www.generac.com/service-support/product-support-lookup/" }
  ],
  "sourceNotes": "Compiled from the Generac air-cooled diagnostic manual 0H9172 and liquid-cooled diagnostic manual 0J1195, the Gentek Power Evolution e-Code lists (air-cooled and liquid-cooled), and support.generac.com. Air-cooled vs liquid-cooled numbering conflicts (2100/2101, 1906/1916) and the field-reported 2670 CAN code are called out inline. Nexus/H-100 use text messages, not 4-digit e-codes. Confirm on the unit's own literature."
 },
 {
