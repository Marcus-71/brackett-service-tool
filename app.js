...
const MODEL_PATTERNS = [
  ...
  { re: /^PRP(?:GE|GN|GX)1[46]/, brand: "Allied Air", equipment: "Gas Furnace", series: "Armstrong Air / AirEase / Ducane / Concord PRPGE gas-electric and PRPGN / PRPGX low-NOx gas-electric Premium Residential packaged unit", notes: ["Read PRPGE1436-090EP-1A as PRP (premium residential package unit) GE (gas/electric; GX or GN low-NOx, AC straight cool, HP heat pump, DF dual fuel) 14 (SEER family) 36 (3 tons) 090 (heating input, 90,000 Btuh) E (ECM constant torque) P (voltage) then major and minor revision.","Tonnage digits 24, 30, 36, 42, 48, 60. Heating input digits 54, 72, 90, 108, 126.","The gas section's direct spark ignition control flashes RATE-CODED fault codes on a single LED - slow flash, fast flash, then 2/3/4/5/6 flash and steady. See Error Codes under the Allied Air packaged ignition control family.","Blower CFM LED: one full flash = 100 CFM, a fast/half flash = 50 CFM (1150 CFM reads as 11 full flashes plus one half).","Blower is delayed 30 seconds after W1/W2 is energized, and the control ignores a second-stage call during the first-stage timing period.","Ducane and Concord list the identical PRP prefixes - the badge on the cabinet does not change the model number."] },
  { re: /^PRPDF1[46]/, brand: "Allied Air", equipment: "Gas Furnace", series: "Armstrong Air / AirEase / Ducane / Concord PRPDF dual-fuel (gas furnace plus heat pump) Premium Residential packaged unit", notes: ["Read PRPGE1436-090EP-1A as PRP (premium residential package unit) GE (gas/electric; GX or GN low-NOx, AC straight cool, HP heat pump, DF dual fuel) 14 (SEER family) 36 (3 tons) 090 (heating input, 90,000 Btuh) E (ECM constant torque) P (voltage) then major and minor revision.","Tonnage digits 24, 30, 36, 42, 48, 60. Heating input digits 54, 72, 90, 108, 126.","The gas section's direct spark ignition control flashes RATE-CODED fault codes on a single LED - slow flash, fast flash, then 2/3/4/5/6 flash and steady. See Error Codes under the Allied Air packaged ignition control family.","Blower CFM LED: one full flash = 100 CFM, a fast/half flash = 50 CFM (1150 CFM reads as 11 full flashes plus one half).","Blower is delayed 30 seconds after W1/W2 is energized, and the control ignores a second-stage call during the first-stage timing period.","Ducane and Concord list the identical PRP prefixes - the badge on the cabinet does not change the model number.","Because this is a dual-fuel unit it also has a heat-pump side. For heat-pump and defrost work, use the Condenser/Heat Pump scenarios in Diagnostics."] },
  { re: /^PRP(?:AC|HP)1[46]/, brand: "Allied Air", equipment: "Condenser/Heat Pump", series: "Armstrong Air / AirEase / Ducane / Concord PRPAC straight-cool and PRPHP heat pump Premium Residential packaged unit", notes: ["Read PRPGE1436-090EP-1A as PRP (premium residential package unit) GE (gas/electric; GX or GN low-NOx, AC straight cool, HP heat pump, DF dual fuel) 14 (SEER family) 36 (3 tons) 090 (heating input, 90,000 Btuh) E (ECM constant torque) P (voltage) then major and minor revision.","Tonnage digits 24, 30, 36, 42, 48, 60. Heating input digits 54, 72, 90, 108, 126.","PRPAC and PRPHP have no gas section, so the gas-ignition rate-coded LED, blower CFM LED and W1/W2 blower-delay behaviour documented for the PRPGE / PRPGN / PRPGX / PRPDF gas models does not apply here.","Ducane and Concord list the identical PRP prefixes - the badge on the cabinet does not change the model number."] },
  ...
  { re: /^VG8S[AD]/, brand: "Nortek", equipment: "Gas Furnace", series: "Nortek (Nordyne) VG8SA / VG8SD single-stage Ultra-Low NOx gas furnace - V-prefix form of FG8SA / FG8SD (G8SA = 80% Category I, G8SD = 95% PVC)", notes: ["Codes are in Error Codes: G8SA has the green + red status pair and yellow flame LED, G8SD the E-code display.", "Natural gas only - no LP kit. Not the 2-stage FG7/KG7 chassis.", "Source: Nordyne install instructions 10500730 (G8SA) and 10501110 (G8SD)."] },
  { re: /^G6T[ACEKL]/, brand: "Nortek", equipment: "Gas Furnace", series: "Nortek (Nordyne unbranded) G6TA / G6TC / G6TE / G6TK / G6TL two-stage gas furnace - older G6 platform, unprefixed form of FG6T / KG6T", notes: ["Older Nordyne G6 furnace. Codes are in Error Codes - open the door and check which board it carries: G6/L1 (red flash count + yellow flame) or G7 (green + red pair).", "LP orifices and pressures are in LP kit 10502460; natural-gas manifold pressure is not in any available document - read the rating plate.", "Source: Nordyne tech specs 690B / 027B / 459C, RPL 708700C, LP kit 10502460."] },
  ...
  { re: /^DV[0-9]{2}[FP]EC/, brand: "Daikin", equipment: "Air Handler", series: "Daikin DV**FEC/PEC EEV air handler (R-410A; F = FIT-matched, P = non-FIT)", notes: ["Air-handler code table (EE/Eb/Ed/E5/EF, d/b series, 70-77) in Error Codes applies.", "Model decode: DV + capacity + P/F + E (EEV) + C (communicating) + cabinet B/C/D + 1 (208/230-1) + 4 (R-410A) (SS-DVPEC 03/21, SS-DVFEC 01/22).", "FIT system service manuals are in Manuals → Daikin."] },
  ...
  // --- Mitsubishi ---
  { re: /^PUY-A(12|18|24|30|36|42)NHA3/, brand: "Mitsubishi", equipment: "Mini-Split", series: "Mitsubishi Mr. Slim P-series PUY-A NHA3 single-zone cooling-only outdoor unit", notes: ["Cooling-only: no heat, no defrost. Pairs 1:1 with a P-series indoor (PLA/PCA/PKA/PEA/PEAD).", "Chargeless to 70 ft (A12-A36) / 100 ft (A42); pump-down uses SWP on the outdoor board.", "Source: Mitsubishi Electric Service Manual OCH458 (PUZ/PUY-A NHA3)."] },
  { re: /^MUFZ-?KJ(09|12|15|18)NAHZ/, brand: "Mitsubishi", equipment: "Mini-Split", series: "Mitsubishi MUFZ-KJ hyper-heating single-zone heat pump outdoor (pairs with MFZ-KJ floor-mounted indoor)", notes: ["Heat pump. No published forced-defrost method; the defrost finish temp is set by the JS jumper.", "Precharged for 25 ft. Max 65 ft (09/12) / 100 ft (15/18).", "Source: Mitsubishi Electric Service Manual OBH753 Rev. B (MUFZ-KJ09-18NAHZ-U1)."] },
  { re: /^MFZ-KJ(09|12|15|18)NA/, brand: "Mitsubishi", equipment: "Mini-Split", series: "Mitsubishi MFZ-KJ floor-mounted indoor unit (single-zone with MUFZ-KJ, or on an MXZ multi-zone)", notes: ["Check the outdoor tag: MUFZ-KJ = single-zone; MXZ = multi-zone (different charge and codes).", "Source: Mitsubishi Electric Indoor Service Manual OBH752 Rev. B (MFZ-KJ09-18NA-U1)."] },
  ...
  { re: /^ND[GL]K[0-9]{3}/, brand: "ICP", equipment: "Gas Furnace", series: "Inter-City Products N-series counterflow (downflow) condensing gas furnace - NDLK (factory LP) / NDGK (natural gas twin)", notes: ["Read NDLK100DG07 as N (furnace) D (downflow/counterflow) L (LP/propane; G = natural gas) K (generation) 100 (100,000 BTU input). It is a condensing furnace, not a generator.", "Source: Inter-City Products 'Condensing Gas Furnaces Service Manual' Part No. 2146635."] },
  { re: /^[GA][MC]VC95[0-9]{4}[BCD]X/, brand: "Goodman", equipment: "Gas Furnace", series: "Goodman / Amana GMVC95 / GCVC95 / AMVC95 / ACVC95 95% AFUE two-stage variable-speed ComfortNet condensing gas furnace", notes: ["Read GCVC950915DXAC as G (Goodman; A = Amana) C (counterflow/horizontal; M = upflow/horizontal) V (variable speed) C (ComfortNet communicating) 95 (AFUE) 091 (input code, 90,000 nominal) 5 (airflow, 2000 CFM) D (24-1/2 in. cabinet) X (low NOx) then major/minor revision.", "Control is the White-Rodgers 50C51-289 ComfortNet integrated ignition control (Goodman PCBKF101/102; PCBKF103 from revision AD); faults show on the dual 7-segment LEDs through the blower-door window.", "Not the GMVC96/GCVC96 platform: #43 natural gas orifice, Honeywell VR9205 or White-Rodgers 36G54 two-stage valve, LPM-05/LPM-06 LP kit, 5.0 in. w.c. minimum natural gas supply.", "Source: Goodman Technical Manual RT6612021 Rev. 4 (12/2010), Installation Instructions IO-341D, Service Instructions RS6610004r23."] },
  { re: /^48FC[DEFLRST][ABCMN]0[4-7]/, brand: "Carrier", equipment: "Other", series: "Carrier WeatherMaker 48FC sizes 04-07 (3-6 ton) single-packaged rooftop, gas heat / electric cooling, R-410A, standard efficiency - e.g. 48FCEA06A2A6A0A0A0 = 5 ton, 460-3, medium gas heat, EcoBlue direct-drive fan", notes: ["Decode: position 5 is heat size (D/E/F low/med/high; S/R/T stainless; L low NOx); position 6 is cooling (A/C one stage; M/N two stage, size 07; B/N Humidi-MiZer); positions 7-8 are tons (04=3 up to 07=6); position 12 is voltage (1=575-3, 3=208/230-1, 5=208/230-3, 6=460-3).","Controls: position 14 is 0 or 6 for electro-mechanical (with W7212 or W7220 economizer), 2 for RTU Open, 3 for SystemVu. The EcoBlue direct-drive fan is set in VDC on the unit control board.","Charging: weigh in the nameplate charge. For a low charge, use the size/phase charging chart in the SM (Figs. 24-34), with panels on.","Sizes 08-16 are covered by a separate manual (48FC-8-16-01SM) and are not matched by this rule. Full size-06 figures are in Maintenance Figures under Carrier 48FC 04-07.","Source: Carrier 48FC-4-7-03SI, 48-50FC-4-7-05PD Rev B, 48FC-4-7-03SM Rev A."] },
  { re: /^FV4AN[FB]00[2356]/, brand: "Carrier", equipment: "Air Handler", series: "Carrier FV4A variable-speed multipoise fan coil, R-410A (Puron), sizes 002-006 - Easy Select board, not communicating (not the FV4B / FV4C)", notes: ["FV4A variable-speed fan coil, R-410A (Puron). Model format FV4A + N (208/230/1) + F/B cabinet + size 002-006 + heater kW (000 = no heater).","ECM blower set on the Easy Select board: heater kW, AC/HP size, system type (AC / HP-COMFORT / HP-EFF), CFM adjust +15%/-10%. No LED codes are published; check the 5 A board fuse and 24 VAC first.","Factory TXV. Charge using the outdoor unit's charging method; a liquid-line drier is required.","Source: Carrier IM-FV4A-05 (installation instructions) and FV4A-4PD (product data)."] },
  { re: /^H[124I]D[ABEH][0O][1-7I][02468O]/, brand: "York", equipment: "Condenser/Heat Pump", series: "York Stellar 2000 R-22 split A/C condensing unit - H*DB is 10 SEER; the same manual also covers H*DE (11 SEER), H*DH (12 SEER) and H*DA (50 Hz)", notes: ["Nomenclature, using the manual's example 'H 4 DB 030 S 06': H = condensing unit; 4 = product generation (design level); DB = 10.00 SEER condensing unit (DE = 11.00, DH = 12.00, DA = 50 Hz); 030 = nominal capacity in BTUH (012 to 076); S = sweat-connect; 06 = 208/230-1-60 (25 = 208/230-3-60, 46 = 460-3-60, 58 = 575-3-60, 78 = 230-1-50, 50 = 380/415-3-50). So H1DB018S06 is a 1st-generation, 10 SEER, 18,000 BTUH, sweat-connect, 208/230 1-phase unit. The trailing 'A' (or '4') on the scans is not in the nomenclature - probably a revision suffix or an OCR artifact, but that is a guess.","Charging and metering: R-22. The factory charge covers a matched coil plus 15 ft of line; add the line-length charge beyond that from the Tabular Data Sheet. The indoor coil uses an orifice (piston), which must be checked against the Tabular Data Sheet for the match - remove it if a TXV kit is required; the tech guide says a TXV must be used with a hard-start kit. For service, use the superheat method: indoor wet bulb and outdoor dry bulb give the target superheat (Table 1), and that plus suction pressure gives the required suction tube temperature (Table 2).","Source: York/UPG Installation Instructions 'Stellar Air Conditioning Unit, Split-System Cooling, H*DB012-76 / H*DE024-60 / H*DH018-60 / H*DA018-076', Form 550.38-N1Y (999), part 035-14562-000 Rev A; York Technical Guide 550.38-TG2Y (197), 'Stellar 2000 DB Series 10.00 SEER, H*DB012 thru H*DB076'. Neither document mentions Guardian - brand is York only."] },
  { re: /^FHMA5[XB]/, brand: "ICP", equipment: "Air Handler", series: "ICP Performance Series FHMA5 multipoise fan coil (sold as Heil, Tempstar, etc.): 5-speed ECM, R-454B, factory TXV, sizes 18 to 60", notes: ["Nomenclature for FHMA5X30L0BA: F = fan coil; H = 5-speed ECM (C = ION variable-speed, per the FCMA5 doc); M = multipoise; A = series; 5 = R-454B; X = singular (one-piece), TXV (B = modular 2-piece, TXV); 30 = 30,000 BTUH; L = aluminum coil; B = 17 in. cabinet (A = 14 in., C = 21 in., D = 24 in.); last A = series code. The '0' in position 10 has no label in the legend, and a trailing '03E' on a scan is not in the nomenclature.","Metering: factory-installed R-454B TXV on all sizes; the replacement part number is listed per size. Refrigerant leak detection/dissipation system is standard. The doc lists 5-speed taps, electric heat from 3 to 30 kW as a field-installed accessory, and 2-piece modular construction on sizes 42 to 60.","Source: ICP/Carrier Product Data 'FHMA5 Performance Series Fan Coil, Multipoise, ECM Motor, for R-454B Refrigerant, Sizes 18-60', Catalog No. FHM5-11-01PD, Edition 03/25; sibling decode from Catalog No. FCMA5-41-02PD (Edition 6/25). Distributors list the identical model under Heil, Tempstar and ICP, but no manufacturer document confirms brand-specific letters."] },
  { re: /^59TP5[A-Z]\d{3}E/, brand: "Carrier", equipment: "Gas Furnace", series: "Carrier 59TP5A Performance Boost two-stage, 4-way multipoise condensing gas furnace, Series 100 - multi-speed ECM with 5 speed taps (not variable speed), non-communicating, 96.2-96.7% AFUE", notes: ["Decode: 59 (family) · T (two-stage) · P (Performance) · 5 (95% AFUE class) · A (major series) · 040/060/080/100/120 (input) · E (motor) · 14/17/21/24 (cabinet width) · -- · 10-22 (airflow, x100 CFM). The 59TP5A always uses motor letter E; no 59TP5B exists in Carrier literature.","Two-stage gas valve and two-speed inducer; the blower is a basic multi-speed ECM with 5 speed taps, so the furnace does NOT set its own airflow - adjust the tap for proper rise. No LCD, no NFC, no communication. Blower off-delay is on setup switches SW-2/SW-3 (90/120/150/180 s), two-stage lockout on SW-1 (LHT).","OCR trap: a tag reading '59TPBBOSOV171116' is a 59TP6B080V17--16 (B for 6, O for 0, S for 8, '11' for '--') - a 59TP5 never has a V motor or a 100V17 size, so that unit belongs to the 59TP6/59TP7 rule.","Source: Carrier 59TP5A-07SI Installation, Start-up, Operating and Service and Maintenance Instructions (05/13); Carrier 59TP5A-02PD Product Data (10/11)."] },
  { re: /^ELO183(UF|BF|BR|DH)\d{2,3}\/?\d{2,3}P\d{2}/, brand: "Lennox", equipment: "Gas Furnace", series: "Lennox Elite ELO183 OIL furnace - ELO183UF (upflow), ELO183BF / ELO183BR (lo-boy front / rear flue), ELO183DH (downflow/horizontal), PSC blower", notes: ["Read ELO183UF135/150P60 as EL (Elite) O (oil) 1 (one stage) 83 (nominal AFUE) UF (upflow; BF = lo-boy front flue, BR = lo-boy rear flue, DH = downflow/horizontal) 135/150 (input with the low-fire / high-fire nozzle) P (PSC blower) 60 (add-on cooling tons). The slash may be missing on a scanned tag.", "The 68/86 is the only size on 100 psig with a hollow low-fire nozzle; every other size is 140 psig.", "Beckett AFG burner with a GeniSys 7505B primary (red = lockout, green = flame, yellow = pump prime); PSC blower with DIP-switch fan delays. It is an OIL furnace filed under Gas Furnace - use the Maintenance Figures entry for nozzles, pump pressure, draft and burner specs.", "Source: Lennox ELO183UF Product Specifications, Bulletin 210628; ELO183UF Installation Instructions 506901-02."] },
  { re: /^SLO185(UF|BF|BR)\d{2,3}\/?\d{3}V\d{2}/, brand: "Lennox", equipment: "Gas Furnace", series: "Lennox Dave Lennox Signature SLO185 OIL furnace - SLO185UFV (upflow), SLO185BFV / SLO185BRV (lo-boy front / rear flue), variable-speed blower", notes: ["Read SLO185BR124/141V60 as SL (Signature) O (oil) 1 (one stage) 85 (nominal AFUE) BR (lo-boy rear flue; UF = upflow, BF = lo-boy front flue) 124/141 (input at low / high fire) V (variable speed) 60 (add-on cooling tons). The slash may be missing on a scanned tag.", "Beckett NX burner, 60° A hollow nozzles, 145-150 psig pump; A54 variable-speed blower control with a CFM LED (1 flash per 100 cfm). NOT for Harmony zoning.", "It is an OIL furnace filed under Gas Furnace - use the Maintenance Figures entry for nozzles, pump pressure, draft and burner specs.", "Source: Lennox SLO185UFV Product Specifications, Bulletin 210676; SLO185UFV Installation Instructions 507263-01."] },
  // ---- v191: Daikin batch - Tag Scanner rules only where the scanner had none ----
  { re: /^D[MC]92SS\d{4}[A-D]N/, brand: "Daikin", equipment: "Gas Furnace", series: "Daikin DM92SS / DC92SS 92% single-stage gas furnace, 4-speed PSC blower", notes: ["Position 6 S = multi-speed PSC blower. Single-LED flash codes 1-8; continuous flashing = reversed polarity (IOD-2010M).", "Single-stage valve: set high fire only (3.5 in. w.c. NG, 10.0 in. LP). IOD-2010M p.11 misprints a Low Stage 1.9/6.0 line.", "See the Maintenance Figures screen for service specs on this unit."] },
  { re: /^DM92SE\d{4}[A-D]N/, brand: "Daikin", equipment: "Gas Furnace", series: "Daikin DM92SE 92% single-stage gas furnace, 5-speed ECM, low NOx", notes: ["5-speed ECM set by DIP switch. Red LED codes 1-12 (IOD-2017J).", "DM96SE / DC96SE are matched by the Daikin 96% rule above.", "See the Maintenance Figures screen for service specs on this unit."] },
  { re: /^DV(25|29|31|33|35|37|39|49|59|61)PTC[BCD]14/, brand: "Daikin", equipment: "Air Handler", series: "Daikin DVPTC communicating variable-speed air handler with TXV, R-410A", notes: ["Position 8 = cabinet (B/C/D); 14 = 208/230 V, R-410A.", "Communicating ECM; the green LED blinks once per 100 CFM.", "TXV: 7-9 F subcooling and 7-9 F superheat on low stage (IOD-4021K / SS-DVPTC).", "See the Maintenance Figures screen for service specs on this unit."] },
