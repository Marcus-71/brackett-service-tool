...
const MODEL_PATTERNS = [
  ...
  { re: /^(JD[UEP]|JHC|JHE|JMC|JME|JMET)[0-9]/, brand: "York", equipment: "Air Handler", series: "York / Coleman / Luxaire next-generation air handler - JDU (4-stage), JDE (2-stage), JDP (fixed speed), JHC (variable speed), JHE (single-piece multi-speed), JMC (constant CFM modular), JME / JMET (modular multi-speed)", notes: ["GAP: no installation manual has been published on an official host for this naming wave - only a JHE/JME sell sheet. No fault codes, no nomenclature chart.","These appear alongside AE / AVC / AVV / MVC on the current site and look like their eventual replacement.","JHET is already covered by the existing York air handler rule; this rule picks up the rest of the J-series."] },
  // --- end coverage:york ---
  // --- coverage:rheem (v123) ---
...
const WARRANTY_PORTALS = {
  ...
  "ameristar": { label: "Ameristar warranty (register / lookup)", url: "https://ameristarhvac.com/warranty/", needs: "unconfirmed - the page is JS-rendered and the lookup fields were not extracted", note: "Ameristar registration runs through American Standard: register at americanstandardair.com or 855-260-2975 within 60 days; general line 1-844-997-4569. Typical coverage on the side-discharge line is 10 year functional parts registered, 5 year unregistered." },
...
const BRAND_TO_BADGE = { Goodman: "GOODMAN", Daikin: "DAIKIN", Carrier: "CARRIER", Lennox: "LENNOX", Trane: "TRANE", York: "YORK", Rheem: "RHEEM", Mitsubishi: "MITSUBISHI", Bosch: "BOSCH", Nortek: "NORTEK", ICP: "ICP", "Allied Air": "ALLIED", "Allied Air": "ALLIED" };
